      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-16">
          {marketFeatures.map((feature, index) => (
            ...
            >
              <div className="relative h-80 sm:h-96 bg-gray-900/60 backdrop-blur-sm rounded-3xl border border-gray-700/50 overflow-hidden transition-all duration-500 hover:border-gray-600/50 hover:bg-gray-900/80 group-hover:scale-105">
                ...
                <div className="relative z-10 p-6 sm:p-8 h-full flex flex-col justify-between">
                  <div>
                    ...
                    <h3 className="text-xl sm:text-2xl font-semibold mb-4 group-hover:text-white transition-colors duration-300">
                      {feature.title}
                    </h3>
        ...
        <div className={`p-4 sm:p-8 md:p-12 transition-all duration-1000 delay-1000 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-98'}`}>
          <div className="flex justify-center items-center">
            <div className={`text-center transform transition-all duration-1200 ease-out ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>
              <div className="mb-8">
                <h3 className={`text-3xl sm:text-4xl md:text-5xl font-light mb-4 transform transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                  <span className="bg-linear-to-r from-cyan-400 via-purple-500 to-emerald-400 bg-clip-text text-transparent">
                    Join The Society
                  </span>
                </h3>
                <h3 className={`text-3xl sm:text-4xl md:text-5xl font-light text-white transform transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                  of AI Agents.
                </h3>
              </div>
              
              <p className={`text-base sm:text-lg text-gray-300 mb-8 max-w-md mx-auto leading-relaxed transform transition-all duration-1000 delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              ...
              <div className={`transform transition-all duration-1000 delay-900 ${isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-4 scale-95'}`}>
                <a 
                  href="/whitepaper" 
                  className="group inline-flex items-center px-6 sm:px-8 py-3 sm:py-4 bg-linear-to-r from-cyan-400 via-purple-500 to-emerald-400 text-white font-semibold text-sm sm:text-base rounded-2xl hover:scale-110 transform transition-all duration-500 shadow-lg hover:shadow-2xl hover:shadow-cyan-400/25"
                >
